                ...
                <client-only>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      >
                        <i class="fa fa-check-circle"></i> {{ invoice.status }}
                      </button>
                      <button
                      ...
                      >
                        <i class="fa fa-times-circle"></i> {{ invoice.status }}
                      </button>
                    </td>
                  </tr>
                </client-only>
          ...
          <div class="card border-0 rounded shadow-sm border-top-orange mt-4">
            <div class="card-header">
              <span class="font-weight-bold"
                ><i class="fa fa-shopping-cart"></i> DETAIL ITEMS</span
              >
            </div>
            <div class="card-body">
              <table
...
export default {
  ...
  async asyncData({ store, route }) {
    await store.dispatch(
      "customer/invoice/getDetailInvoice",
