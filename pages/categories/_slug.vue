  ...
  <div class="container-fluid mt-custom">
    <div class="fade-in">
      <div class="row">
        <div class="col-md-12">
          <h3>
            CATEGORY : <strong>{{ category.name.toUpperCase() }}</strong>
          </h3>
          <!-- Solid divider -->
          <hr class="solid" />
        </div>
...
export default {
  ...
  head() {
    return {
      title: `Category : ${this.category.name}  - TOKO BOY - Distributor Bali Indonesia Resmi`,
      meta: [
        {
          hid: "og:title",
          name: "og:title",
          content: `Category : ${this.category.name}  - TOKO BOY - Distributor Bali Indonesia Resmi`,
        },
        {
          hid: "og:site_name",
          name: "og:site_name",
