...
export default {
  ...
  head() {
    return {
      title: "Cart - TOKO BOY - Distributor Bali Indonesia Resmi",
      meta: [
        {
          hid: "og:title",
          name: "og:title",
          content: "Cart - TOKO BOY - Distributor Bali Indonesia Resmi",
        },
        {
          hid: "og:site_name",
          name: "og:site_name",
        ...
        },
        {
          hid: "description",
          name: "description",
          content: "Cart - Official Toko Online Penjualan Produk Bali",
        },
      ],
    };
  },
  ...
  methods: {
    ...
    getServiceCost() {
      ...
      //sum grandTotal
      this.grandTotal =
        parseInt(this.cartPrice) + parseInt(this.courier.courier_cost);
