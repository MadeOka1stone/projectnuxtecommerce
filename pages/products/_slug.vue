                  ...
                  <tbody>
                    <client-only>
                      <tr>
                        ...
                        <td>
                          <strong>{{ product.weight }}</strong> gram
                        </td>
                      </tr>
                      <tr>
                        <th class="pl-0 w-25" scope="row">
...
export default {
  ...
  head() {
    return {
      title: `${this.product.title} - TOKO BOY - Distributor Bali Indonesia Resmi`,
      meta: [
        {
          hid: "og:title",
          name: "og:title",
          content: `${this.product.title} - TOKO BOY - Distributor Bali Indonesia Resmi`,
        },
        {
          hid: "og:site_name",
          name: "og:site_name",
