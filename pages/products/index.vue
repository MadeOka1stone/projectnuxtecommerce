...
export default {
  ...
  head() {
    return {
      title: "Products - TOKO BOY - Distributor Bali Indonesia Resmi",
      meta: [
        {
          hid: "og:title",
          name: "og:title",
          content: "TOKO BOY - Distributor Bali Indonesia Resmi",
        },
        {
          hid: "og:site_name",
          name: "og:site_name",
          content: "Products - TOKO BOY - Distributor Bali Indonesia Resmi",
        },
        {
          hid: "og:image",
          name: "og:image",
        ...
        },
        {
          hid: "description",
          name: "description",
          content: "Jual Produk Original Bali Indonesia Bergaransi Resmi",
        },
      ],
    };
  },
